        ...
        Column(
            ...
            PhotoSection(
                ...
                onTakePhoto = {
                    ...
                    if (cameraPermission?.status?.isGranted == true) {
                        // Creer fichier temporaire pour la photo
            ...
            LocationSection(
                ...
                onGetCurrentLocation = {
                    // Verification permission localisation
...
private fun LocationSection(
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            // Carte Google Maps (affichee si localisation selectionnee)
            if (location != null) {
                Spacer(modifier = Modifier.height(12.dp))
                ...
                // Mise a jour de la camera quand la location change
...
private fun getCurrentLocation(
    ...
    // Utiliser getCurrentLocation au lieu de lastLocation pour une position fiable
...
// Fonction pour obtenir le nom affichable de la categorie
@Composable
